...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <ul class="nav menu">
        ...
        <li class=""><a href="index.php"><em class="fa fa-home">&nbsp;</em> Class</a></li>
        <li class=""><a href="index.php"><em class="fa fa-credit-card-alt">&nbsp;</em> Payment</a></li>
        <li class=""><a href="index.php"><em class="fa fa-id-card">&nbsp;</em> Profile</a></li>
    </ul>
</div>
